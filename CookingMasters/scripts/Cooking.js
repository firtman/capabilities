import { turnOn } from "./BTLights.js";
...
export const Cooking = {
    ...
    sayStep: () => {
        app.capabilities.say(Cooking.recipe.steps[Cooking.currentStep].description);
    },
    step: (index) => {
        ...
        document.querySelector("#cooking .step").innerHTML = step.description + " <span>🗣️</span>";
        document.querySelector("#cooking .step span").onclick = (event) => {
            Cooking.sayStep();
        };
